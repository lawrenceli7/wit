/**
 * Abstract class representing a two-dimensional colored shape
 *
 * @author Lawrence Li
 */
public abstract class Shape2D {
  ...
  public static final double THRESH = 1.0E-5;

  /**
   * Returns true if two numbers are considered close enough
   *
   * @param a value 1
   * @param b value 2
   ...
   *
   * @return something like "Red Rectangle @ ((0.000, 0.000), (0.000, 1.000),
   *         (1.000, 1.000), (1.000, 0.000)): center=(0.000, 0.000),
   *         perimeter=4.000, area=1.000"
   */
  @Override
  public final String toString() {
    return String.format(
      "%s %s @ (%s): center=%s, perimeter=%.3f, area=%.3f",
      color,
      shapeName,
      vToString(),
      getCenter(),
