...
public class Point2D {
  ...
  /**
   * Returns true if provided another point that is at the same (x,y) location
   * (that is, the distance is "close enough" according to Shape2D)
   *
   * @param o another object
   * @return true if the other object is a point and the same location (within
   *         threshold)
   */
  @Override
  public boolean equals(Object o) {
    if (o instanceof Point2D) {
      Point2D p = (Point2D) o;
      return Shape2D.closeEnough(0.0, distanceTo(p));
    } else {
      return false;
    }
  }
